<?php
    if (($_SESSION['rights'] === '2') AND (session_status() != 1)) {
?>
    <!DOCTYPE html>
    <html lang="fr">
    <head>
                ...
                <div class="bg-dark p-4 d-flex justify-content-center">
                    <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
                        ...
                        <div class="container-fluid">
                            <div class="resizeImg">
                                <a class="navbar-brand" href="/outils/Controllers/Controller_responsable.php?action=home">
                            ...
                            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-toggle" href="#" id="navbarSuiviMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">Répertoire</a>
                                        <ul class="dropdown-menu" aria-labelledby="navbarSuiviMenuLink">
                                            <li><a class="dropdown-item" href="/outils/Controllers/Controller_responsable.php?action=prospectsListing">Listing prospects</a></li>
                                            <li><a class="dropdown-item" href="/outils/Controllers/Controller_responsable.php?action=clientsListing">Listing clients</a></li>
                                        </ul>
                                    </li>
                                    <li class="nav-item">

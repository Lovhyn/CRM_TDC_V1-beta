<?php
    if (($_SESSION['rights'] === '1') AND (session_status() != 1)){
?>
    <!DOCTYPE html>
    <html lang="fr">
    <head>
                                ...
                                <ul class="navbar-nav">
                                    ...
                                    <!-- <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarSuiviMenuLink">
                                            <li><a class="dropdown-item" href="/outils/Controllers/Controller_admin.php?action=prospectActivity">Suivi des prospects</a></li>
                                            <li><a class="dropdown-item" href="/outils/Controllers/Controller_admin.php?action=clientActivity">Suivi des clients</a></li>
                                        </ul>
                                    </li> -->
                                    <li class="nav-item dropdown">

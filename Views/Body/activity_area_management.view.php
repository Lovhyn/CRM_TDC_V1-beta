...
<hr>
    ...
    <div class="d-flex justify-content-center">
        <form id="newActivityAreaForm" class="d-flex justify-content-center mt-3" action="/outils/Controllers/Controller_admin.php?action=addAreaActivity" method="post">
            ...
            <button type="submit" value="addAreaActivity" class="addAreaActivityBtn" onclick="return confirm('Etes-vous sûr(e) de vouloir ajouter ce secteur d\'activité ?')">
...
//      Récupère la liste des secteurs d'activité.
        ...
        foreach($tSecteurs as $tSecteur) {
            ...
            '<tr>
                ...
                <form class="d-flex justify-content-center" action="/outils/Controllers/Controller_admin.php?action=updateActivityArea" method="post">
                    <td>
                    ...
                    <td class="text-center">
                        <button class="validIcon" type="submit" name="action" value="updActivityArea">
            ...
            if ($flag == false) {
                ...
                echo
                '<td>
                    <form class="d-flex justify-content-center" action="/outils/Controllers/Controller_admin.php?action=deleteActivityArea" method="post">
                        <button class="delIcon" type="submit" name="action" value="delActivityArea" '; echo($dialogBoxMsg); echo'>
